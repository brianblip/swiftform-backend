...
Revision ID: b13b6ff08c52
Revises: 
Create Date: 2024-01-05 10:36:51.930265
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('form_id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('TEXTFIELD', 'TEXTAREA', 'MULTIPLE_CHOICE', 'CHECKBOX', 'DROPDOWN', 'ATTACHMENT', 'SLIDER', 'DATE', name='question_type'), nullable=False),
